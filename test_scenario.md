...
5. Thiết lập tỷ lệ hoa hồng mặc định của shop (Ví dụ sửa từ `10%` thành `12%` Không sửa > 20% làm vậy sẽ vi phạm điều khoản lúc đăng ký tài). Bấm **Cập nhật**.
...
3. Bấm biểu tượng dấu **+** ở góc bên phải để tạo yêu cầu ký gửi mới.
